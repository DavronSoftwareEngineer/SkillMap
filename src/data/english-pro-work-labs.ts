...
export const ENGLISH_PRO_WORK_LABS: Module[] = [
  {
    ...
    tasks: [
      { id: "en-audio-1", html: "3 ta turli speaker yoki tezlikdagi real audio tanladim", crit: "source, title, duration, timestamp va transcript qayd etilgan; accent faqat manbada tasdiqlangan bo‘lsa belgilanadi, aks holda unknown" },
    ...
    project: { tag: "Listening evidence", title: "Real listening and meeting pack", desc: "Real audio asosida note, transcript correction, clarification va shadowing dalilini yig'ing. Quyidagi browser-voice mashqi sintetik, real audio dalili o‘rniga o‘tmaydi.", features: ["3 audio source", "first-pass notes", "transcript corrections", "action summary", "shadowing recording"], rubric: ["Fact va inference aralashmagan.", "Action/owner/deadline aniq.", "Noma'lum joy taxmin qilinmay, clarificationga aylantirilgan."] },
    quiz: [
