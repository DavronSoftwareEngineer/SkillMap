...
export const COURSES: CourseMeta[] = [
  ...
  },
  {
    ...
    books: [
      ...
      { n: 5, accent: E, title: "Blue Team Handbook: SOC, SIEM and Threat Hunting", author: "Don Murdoch", isbn: "9781726273985", note: "SOC, log, alert, hunting va incident handling uchun ixcham amaliy qo'llanma." },
  ...
  },
  {
    ...
    books: [
      ...
      { n: 6, accent: F, title: "Pul psixologiyasi / The Psychology of Money", author: "Morgan Housel", isbn: "9780857197689", note: "Pul haqidagi qarorlar, xulq-atvor, risk va uzoq muddatli fikrlashni real hikoyalar orqali tushuntiradi." },
    ],
  ...
  },
  {
    ...
    books: [
      { n: 1, accent: A, title: "Поехали!", author: "С. Чернышов", isbn: "9785907123007", note: "Noldan boshlovchilar uchun mashhur darslik. Talaffuz, alifbo, oddiy suhbat - kursning birinchi modullariga mos." },
      { n: 2, accent: B, title: "Русский язык в упражнениях", author: "С. А. Хавронина, А. И. Широченская", isbn: "9785883373823", note: "Grammatika + mashqlar. Kelishiklar va fe'l aspekti modullari uchun amaliyot manbasi." },
  ...
  },
  {
    ...
    books: [
      ...
      { n: 4, accent: D, title: "85% of Qur'anic Words", author: "Abdulazeez Abdulraheem", note: "80% kitobining tuzatilgan va kengaytirilgan bepul nashri: chastota bo'yicha Qur'on lug'ati va fe'l shakllari." },
  ...
  },
  {
    ...
    books: [
      ...
      { n: 2, accent: B, title: "Prompt Engineering for Generative AI", author: "James Phoenix, Mike Taylor", isbn: "9781098153434", note: "Prompt texnikalari amaliy va tizimli: rol, few-shot, structured output va workflow patternlari." },
